...
> Furthermore the service principal of the Entra app is a member of the Entra group `tf-playground-rg-iac-contributor` and the following Microsoft Graph application permissions got added
>
